...
public class ApiDateFormat {	
	 ...
	 * System.out.println("BaseTimeFormat" + startDate); switch
	 * (startDate.substring(8,10)) { case "03": case "04": case "05":
	 * startDate.replace(8, 12, "0200"); break; case "06": case "07": case "08":
	 * startDate.replace(8, 12, "0500"); break; case "09": case "10": case "11":
	 * startDate.replace(8, 12, "0800"); break; case "12": case "13": case "14":
	 * startDate.replace(8, 12, "1100"); break; case "15": case "16": case "17":
	 * startDate.replace(8, 12, "1400"); break; case "18": case "19": case "20":
	 * startDate.replace(8, 12, "1700"); break; case "21": case "22": case "23":
	 * startDate.replace(8, 12, "2000"); break; case "00": case "01": case "02": int
	 * year = Integer.parseInt(startDate.substring(4, 8)) -1; // 금일 시간 -1
	 * startDate.replace(5, 9,String.valueOf(year)); startDate.replace(8, 12,
	 * "2300"); break; default: break; } System.out.println("AfterBaseTimeFormat" +
